                ...
                <table class="sortable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><%= C.getNombre()%></td>
                            <td><%= C.getCreditos()%></td>
                            <td><a id="linkEliminarCurso" onclick="if(!confirm('¿Esta seguro que desea eliminar este Curso?'))return false" href="EliminarCursoS?C=<%=C.getIdCurso()%>"><i class="icon-remove"></i></a></td>
                        </tr>                    
                        <%
                            }
                        %>
